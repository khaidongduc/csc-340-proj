...
CREATE TABLE IF NOT EXISTS building (
    ...
    FOREIGN KEY (parking_lot_no)
        REFERENCES parking_lot (parking_lot_no)
);
...
CREATE TABLE IF NOT EXISTS tenant (
    ...
    FOREIGN KEY (person_phone)
        REFERENCES person (phone),
    FOREIGN KEY (depended_tenant_phone)
        REFERENCES tenant (person_phone)
);
...
CREATE TABLE IF NOT EXISTS rented_apartment (
    ...
    FOREIGN KEY (building_no)
        REFERENCES building (building_no),
    FOREIGN KEY (lease_tenant_phone)
        REFERENCES tenant (person_phone)
);
...
CREATE TABLE IF NOT EXISTS subscribed (
    ...
    FOREIGN KEY (person_phone)
        REFERENCES person (phone),
    FOREIGN KEY (service_building_no , service_name)
        REFERENCES service (building_no , name)
);
